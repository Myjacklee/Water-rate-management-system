                        ...
                        <div class="col-md-6 text-right">
                            <div class="btn-group">
                                <button type="button" class="btn btn-default" data-toggle="modal"
                                        data-target="#addStudent">添加学生
                                </button>
                                <button type="button" class="btn btn-default disabled" data-toggle="modal"
                                        data-target="#">导入学生名单
                                </button>
                                <button type="button" class="btn btn-default" id="printStudentList">打印记次张贴名单</button>
                                <button type="button" class="btn btn-default" data-toggle="modal"
                                        data-target="#deleteStudent">删除学生
                                </button>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="modal-body">
                                    <div class="row">
                                        <div class="addStudentContainer">
                                            <input type="number" class="form-control addStudentControl"
                                                   id="addStudentID" placeholder="学号" required autofocus>
                                            <input type="text" class="form-control addStudentControl"
                                                   id="addStudentName" placeholder="姓名" required>
                                        </div>
                                    </div>
                                </div>
